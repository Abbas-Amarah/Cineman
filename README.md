...
Cinema App is a work-in-progress project that showcases clean, maintainable, and testable code with a **strong separation of concerns**.
It interacts with **TMDB API** to fetch and display real movie data while following **modern Android development best practices**.
